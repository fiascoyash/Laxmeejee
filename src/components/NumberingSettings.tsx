    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-800">Document Numbering</h3>
        </div>
        <p className="text-sm text-gray-500 mt-1">Customize how quotation and invoice numbers are generated.</p>
      </div>
      ...
      <div className="p-6 space-y-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="font-medium text-gray-800">Quotation Number</h4>
          </div>
        ...
        <div className="pt-6 border-t border-gray-100">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="font-medium text-gray-800">Invoice Number</h4>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Prefix</label>
        ...
        <div className="pt-6 border-t border-gray-100">
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <h5 className="text-sm font-medium text-gray-800 mb-1">Manual Override</h5>
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
        ...
        <button
          onClick={handleSave}
          className="ml-auto px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors flex items-center gap-2 text-sm"
        >
